...
\begin{enumerate}
	...
	\textcolor{red}{Note}: Breaks are spaced evenly thoughout the set.\\
	\item Click OK to save the settings.
\end{enumerate}

\scont{Filter Songs}
\subsubsection{Filter Individual Songs}
\begin{enumerate}
...
\end{enumerate}
		...
		When the Genre field in Seltlist Settings is black, all song genres will be available for a setlist.\\
